...
INCLUDE_FLAGS = -I$(IMGUI_DIR) -I$(IMGUI_MD_DIR) -I$(MD4C_DIR) -I$(STB_DIR) -I$(COOLBAR_DIR) -I$(TWEEN_DIR) -I$(FA_DIR) -I$(CS474_DIR) -I$(SPINNER_DIR)
...
# client
$(foreach dir,$(CLIENT_DIR) $(LAYER_DIR) $(GRAPHICS_DIR) $(UTILS_DIR) $(WIDGETS_DIR) $(SPINNER_DIR),$(foreach ext,$(EXTENSIONS),$(eval $(call compile_rule,$(CLIENT_EMSCRIPTEN_RELEASE_INT_DIR),$(dir),$(ext)))))
