...
INCLUDE_FLAGS = -I$(IMGUI_DIR) -I$(IMGUI_MD_DIR) -I$(MD4C_DIR) -I$(STB_DIR) -I$(COOLBAR_DIR) -I$(TWEEN_DIR) -I$(FA_DIR) -I$(CS474_DIR)
...
# imgui
$(foreach dir,$(IMGUI_BACKENDS_DIR) $(IMGUI_DIR) $(IMGUI_MD_DIR) $(MD4C_DIR) $(COOLBAR_DIR),$(foreach ext,$(EXTENSIONS),$(eval $(call compile_rule,$(IMGUI_EMSCRIPTEN_RELEASE_INT_DIR),$(dir),$(ext)))))
...
# client
$(foreach dir,$(CLIENT_DIR) $(LAYER_DIR) $(GRAPHICS_DIR) $(UTILS_DIR) $(WIDGETS_DIR),$(foreach ext,$(EXTENSIONS),$(eval $(call compile_rule,$(CLIENT_EMSCRIPTEN_RELEASE_INT_DIR),$(dir),$(ext)))))
$(CLIENT_EMSCRIPTEN_RELEASE_OUTPUT): $(CLIENT_EMSCRIPTEN_RELEASE_INT_OBJECTS)
	...
	$(CXX) $(CLIENT_EMSCRIPTEN_RELEASE_INT_OBJECTS) -lcs474 -limgui \
	 -g0 -s USE_WEBGL2=1 -s USE_GLFW=3 -s FULL_ES3 -s WASM=1 -s ALLOW_MEMORY_GROWTH -s FETCH=1\
	 --preload-file assets/ \
