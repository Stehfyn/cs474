...
INCLUDE_FLAGS = -I$(IMGUI_DIR) -I$(IMGUI_MD_DIR) -I$(MD4C_DIR) -I$(STB_DIR)
...
# imgui
$(foreach dir,$(IMGUI_BACKENDS_DIR) $(IMGUI_DIR) $(IMGUI_MD_DIR) $(MD4C_DIR),$(foreach ext,$(EXTENSIONS),$(eval $(call compile_rule,$(IMGUI_EMSCRIPTEN_RELEASE_INT_DIR),$(dir),$(ext)))))
